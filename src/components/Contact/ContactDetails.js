  ...
  return (
    <div className="contact-page">
      <section className="hero-all-etudes">
        <h2 className="parallax-cities bottom">Paris</h2>
        ...
        <div className="wrapper_1110">
          <div className="heading">
            ...
            <div className="blocs_w50">
              <div></div>
              <h2>Paris</h2>
              <p>Située en plein coeur du XVIème arrondissement de Paris, au 111, rue de Longchamp, l'Étude occupe le rez-de-chaussée d’un hôtel particulier, rénové très récemment.</p>
